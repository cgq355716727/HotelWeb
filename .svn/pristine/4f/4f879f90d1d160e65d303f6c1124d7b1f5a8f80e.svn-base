...
function validateCard(obj,type){
	...
	$.ajax({
		...
		success: function(json){
			if(json.code==1){
				$("#div_check_credit").html("<img src='checked.gif'/>");
			}else{
				$("#div_check_credit").html("<img src='unchecked.gif'/>"+json.data);
			}
			pc_ret = json.code;
		}
	});
...
function preLoadImages()
{
	...
	imagesArray[0] = 'menu_1r.gif';
	imagesArray[1] = 'menu_2r.gif';
	imagesArray[2] = 'menu_3r.gif';
	imagesArray[3] = 'menu_4r.gif';
	imagesArray[4] = 'menu_5r.gif';
	imagesArray[5] = 'menu_6r.gif';
	imagesArray[6] = 'menu_7r.gif';
	imagesArray[7] = 'menu_8r.gif';
