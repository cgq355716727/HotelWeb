...
<head>	
	...
	<meta name="description" content="酒店后台管理系统">
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="well span5 center login-box">
					...
					<form class="form-horizontal" action="admin.action" method="post">
						<input type="hidden" name="method" value="validate" />
						<fieldset>
							<div class="input-prepend" title="用户名" data-rel="tooltip">
								<span class="add-on"><i class="icon-user"></i></span><input autofocus class="input-large span10" name="adminName" id="adminName" type="text" />
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="密码" data-rel="tooltip">
								<span class="add-on"><i class="icon-lock"></i></span><input class="input-large span10" name="adminPw" id="adminPw" type="password" />
							</div>
							<div class="clearfix"></div>
