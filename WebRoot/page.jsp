...
<!-- saved from url=(0041)http://www.7daysinn.cn/innpage.php?id=983 -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <title> 7天连锁酒店 </title>
  <base href="<%=basePath%>">
  <meta http-equiv="Cache-control" content="private">
    	<meta http-equiv="pragma" content="no-cache">
    	<title>7天长沙人民中路识字岭店--７天连锁酒店官网</title>
	<meta content="7天长沙人民中路识字岭店,介绍,7天长沙人民中路识字岭店预订,7天,连锁酒店预订,酒店网上预订,预定" name="Keywords">
	<meta content="" 亲们，分店已在2013年4月重新装修升级完毕！每个房间独立7兆宽带、免费wifi全覆盖极速畅游。城市中心最低的房价，最优质的服务。本酒店位于位于长沙主干路芙蓉中路和人民中路交汇处，酒店周边紧邻长沙人.."="" name="Description">
  ...
  <div class="header">
    ...
    <div class="toptent">
	  ...
	  <div class="userinfotent">
		...
		<div class="sub_menu">
		<ul>
		  <div id="tool" class="tool"><a href="hotellist.action?method=queryallRoomTypeVolList&jumpPage=1">快速预订</a>&nbsp;<span class="nalsecimg"> </span>&nbsp;<a href="http://www.7daysinn.cn/innmap.html">从地图进入</a>&nbsp;<span class="nalsecimg"> </span>&nbsp;<a href="http://www.7daysinn.cn/inn_city_list.html">按城市列表显示</a></div>					
		</ul>
	  </div>
    </div>
  </div>
</div>
<!--top end--><link href="images/my7day.css" rel="stylesheet" type="text/css">
...
<script src="images/innpage.js" type="text/javascript"></script>
<script src="images/tipswindown.js" type="text/javascript"></script>
<link rel="stylesheet" href="images/tipswindown.css" type="text/css" media="all">
<script language="javascript" type="text/javascript" src="images/jquery.blockUI.js"></script>
<script language="javascript" type="text/javascript" src="images/start.js"></script>
<script language="javascript" type="text/javascript" src="images/riminfos.js"></script>
<script language="javascript" type="text/javascript">
<!--
var hotel_id = 983;
var dtStart  = '2014-03-31';
var rMebType = '';
var cMebType = '7';
var brandID  = 1;
...
function cooperateCardTips($set_hotel_id,$set_room_id,$set_jifen){
	  ...
	  pgInit();
        ...
        <div class="blank10"></div>
				    ...
				    <div class="left_map_con">
				     ...
				     <p><a href="http://www.7daysinn.cn/map.php?city=%E6%88%90%E9%83%BD">成都</a><span style="width:16px; display:inline-block"></span><a href="http://www.7daysinn.cn/map.php?city=%E9%87%8D%E5%BA%86">重庆</a><span style="width:16px; display:inline-block"></span><a href="http://www.7daysinn.cn/map.php?city=%E6%AD%A6%E6%B1%89">武汉</a><span style="width:16px; display:inline-block"></span><a href="http://www.7daysinn.cn/map.php?city=%E9%95%BF%E6%B2%99">长沙</a></p>
					  <p style="height:30px;overflow:hidden;">					   
					   <input name="mapcity" id="mapcity" type="text" class="inp" style="color:#666666;" value="其他城市" onclick="this.value=&#39;&#39;;" maxlength="9">
					   <input name="" type="button" class="btn" onclick="return citymap();">
				      </p>
				    </div>
				  </div>
				  <div class="lf_b3"></div>
				...
				<div class="blank10"></div>
				  	...
				  	<a href="http://www.7daysinn.cn/activity_lucky.php"><img src="images/2f1ed268f493f2d2d1b5485cab19d7f3.jpg" width="218" height="118" border="0"></a>
			
				  				  <div class="blank10"></div>				  
				  <div>
				  <a href="http://www.7daysinn.cn/wish2014.php"><img src="images/df40cf2fedb570c146f233aa7e1621ab.jpg" width="218" height="118" border="0"></a>
				  </div>
				  				  				  <!-- 铂涛会好兑好睡 -->
				  				  <!-- End -->
						   ...
						   <script language="javascript" type="text/javascript">
									<!--
									ShowAdPic('www_inn_left_1',1,212,80);
									-->
						   </script>
						   ...
						   <script language="javascript" type="text/javascript">
									<!--
									ShowAdPic('www_inn_left_2',1,212,80);
									-->
						   </script>
						   ...
						   <script language="javascript" type="text/javascript">
									<!--
									ShowAdPic('www_inn_left_3',1,212,80);
									-->
						   </script>
...
<div class="middle">
		<h4 style="padding-left: 0px">
		 <a href="http://www.7daysinn.cn/qadd.php" title="Q+服务认证" target="_blank" style="padding: 0px 2px; float: left;">
		 	<img src="images/a233543fa9f1c6b9a56b361b6f7cac3e.gif" alt="Q+服务认证" width="30" height="30">
		 </a>
		<span title="${HotelVo.hotelName}" style="cursor: pointer;">
		${HotelVo.hotelName}
	</span>
	
		</h4>
	 <span class="write"> 
	<a class="icon_little5" href="http://www.7daysinn.cn/innpage.php?id=983#rsInfo1">周边商户信息</a> 
	<a class="icon_little2" href="http://www.7daysinn.cn/map.php?x=112.99284957603&y=28.191056864282&innId=965&city=%E9%95%BF%E6%B2%99&sType=2&end=983">
		电子地图
	</a>
	<a class="icon_little3" href="http://www.7daysinn.cn/inn_comments_details.php?ChainNum=965">
		好评率<span class="cOrange">97.7 %</span>
	</a>
	</span>
</div>
...
<div class="right"><img src="images/bar2_right.gif" alt=""></div>
	...
	<div class="icon_roundq2">
		<span style="display: block; height: 30px; overflow: hidden; padding-left: 30px">
			 
									<a href="http://www.7daysinn.cn/qadd.php?act=wifi" title="免费Wifi覆盖" target="_blank" style="padding: 0px 2px; float: left;">
						<img src="images/017405711691d43e75ae89cdccd51a95.gif" alt="免费Wifi覆盖" width="30" height="30">
					</a>
									<a href="http://www.7daysinn.cn/qadd.php?act=yalan" title="星级优眠床垫" target="_blank" style="padding: 0px 2px; float: left;">
						<img src="images/b8d6d822825c02801bcd3e070a8b4a0f.gif" alt="星级优眠床垫" width="30" height="30">
					</a>
									<a href="http://www.7daysinn.cn/qadd.php?act=maojin" title="洁净封包毛巾" target="_blank" style="padding: 0px 2px; float: left;">
						<img src="images/4bedbbc535270939faa64f7a43035889.gif" alt="洁净封包毛巾" width="30" height="30">
					</a>
									<a href="http://www.7daysinn.cn/qadd.php?act=shower" title="10秒速热淋浴" target="_blank" style="padding: 0px 2px; float: left;">
						<img src="images/21e4a1eb7297ba84d299d8b0ca076672.gif" alt="10秒速热淋浴" width="30" height="30">
					</a>
									</span>
	</div>

<div class="info">
<p style="text-indent: 2em;">${HotelVo.hotelName}分店介绍:${HotelVo.hotelAbout}</p>
</div>
...
<div class="picture">
			...
			<div class="pic">
			<a>
				<img src="images/d52466cf667aefbcb81778c8fe7be496.jpg" alt="">
			</a>
		</div>
		 
			<div class="pic">
			<a>
				<img src="images/8d2c13ca274c6cf0fef30da17fe85cd8.jpg" alt="">
			</a>
		</div>
		 
			<div class="pic">
			<a>
				<img src="images/8db171e4891a8c09d167bf52bd1ccef3.jpg" alt="">
			</a>
		</div>
		<div class="clear"></div>
</div>
...
<div class="left"><img src="images/bar2_left.gif" alt=""></div>
<div class="middle">
<h4 class="icon_round9">分店点评</h4>
<span class="write">
	<a href="http://www.7daysinn.cn/inn_comments_details.php?ChainNum=965&d=5&e=0">好评率
	 <span class="cOrange"><b>97.7 %</b></span></a>
	 <span style="width: 10px; display: inline-block;"></span>
	 <a href="http://www.7daysinn.cn/my_order.php?order_status=50" target="_blank">[我要点评]</a></span></div>
<div class="right"><img src="images/bar2_right.gif" alt=""></div>
</div>
<table class="tb3" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			<th width="20%">综合评价</th>
			<th width="16%">最近1周</th>
			<th width="16%">最近1个月</th>
			<th width="16%">最近3个月</th>
		</tr>
		<tr>
			<td><img src="images/good.gif" align="absmiddle"> 好评</td>
			<td>51</td>
			<td>250</td>
			<td>957</td>
		</tr>
		<tr>
			<td><img src="images/general.gif" align="absmiddle"> 中评</td>
			<td>1</td>
			<td>3</td>
			<td>9</td>
		</tr>
		<tr>
			<td><img src="images/poor.gif" align="absmiddle"> 差评</td>
			<td>0</td>
			<td>1</td>
			<td>4</td>
		</tr>
		<tr>
		<td colspan="4">
		<div style="width:100%;font-family:微软雅黑;font-weight:500;font-size:14px;">累计评价 <font color="blue">4981</font> </div>
		</td></tr>
	</tbody>
</table>
...
<table class="tb4" cellpadding="0" cellspacing="0">
    <tbody>
        <tr>
            <td>
                <span class="stnn01" style="width:60px;">服务态度：</span>
                <div class="stnn02" id="serviceScorePic" style="position: relative;"><p class="studyplay_starBg" style="width: 120px;"><p class="studyplay_starovering" style="width:118.19999999999999px; z-index:0;" id="studyplay_current"></p></p></div>
                <span class="f14px cOrange stnn03">9.85</span>
            </td>
            <td>
                <span class="stnn01" style="width:60px;">干净卫生：</span>
                <div class="stnn02" id="cleanScorePic" style="position: relative;"><p class="studyplay_starBg" style="width: 120px;"><p class="studyplay_starovering" style="width:117.35999999999999px; z-index:0;" id="studyplay_current"></p></p></div>
                <span class="f14px cOrange stnn03">9.78</span>
            </td>
      </tr>
      <tr>      
            <td>
                <span class="stnn01" style="width:60px;">睡眠舒适：</span>
                <div class="stnn02" id="sleepScorePic" style="position: relative;"><p class="studyplay_starBg" style="width: 120px;"><p class="studyplay_starovering" style="width:117.47999999999999px; z-index:0;" id="studyplay_current"></p></p></div>
                <span class="f14px cOrange stnn03">9.79</span>
            </td>
            <td>
                <span class="stnn01" style="width:60px;">淋浴舒适：</span>
                <div class="stnn02" id="comfortScorePic" style="position: relative;"><p class="studyplay_starBg" style="width: 120px;"><p class="studyplay_starovering" style="width:117.24px; z-index:0;" id="studyplay_current"></p></p></div>
                <span class="f14px cOrange stnn03">9.77</span>
            </td>
        </tr>
        <tr>
            
            <td>
                <span class="stnn01" style="width:60px;">网络体验：</span>
                <div class="stnn02" id="wifiScorePic" style="position: relative;"><p class="studyplay_starBg" style="width: 120px;"><p class="studyplay_starovering" style="width:118.19999999999999px; z-index:0;" id="studyplay_current"></p></p></div>
                <span class="f14px cOrange stnn03">9.85</span>
            </td>
        </tr>
        <input type="hidden" id="cleanScore" name="cleanScore" value="9.78">
		<input type="hidden" id="comfortScore" name="comfortScore" value="9.77">
		<input type="hidden" id="serviceScore" name="serviceScore" value="9.85">
		<input type="hidden" id="sleepScore" name="sleepScore" value="9.79">
		<input type="hidden" id="wifiScore" name="wifiScore" value="9.85">
    </tbody>
</table>
</div>
<div class="bottom"></div>
...
<div id="cooperateCardTips" style="display:none; cursor: default;padding:0px;">
<table width="97%" border="0" cellpadding="0" cellspacing="3">
	<tbody><tr>
   	<td style="width:110px;" align="center" valign="top"><img src="images/02.jpg" width="104" height="124"></td>
    <td align="left" style="padding-top:15px;">
        <div style="text-align:left;line-height:20px;text-indent:24px;font-size:14px;">如需预订异地免费房、积分兑换房、88元新店体验等特价房，请以7天会员身份登录并预订。</div>
        <div align="center" style="margin-top:30px; margin-bottom:0px;">
			<input type="button" class="btn_bg_icon_07" value="重新登录" name="Submit2" id="confirmBookingBtn" onclick="location.href=&#39;logout.php?returnURL=innpage.php?id=983&#39;;">&nbsp;&nbsp;&nbsp;
            <input type="button" class="btn_bg_icon_07" value="取消预订" name="Submit2" onclick="closeWindown()">
        </div>
    </td>
...
<iframe id="CalFrame" name="CalFrame" frameborder="0" src="images/datecom.htm" width="452" height="190" scrolling="no" style="display: none; position: absolute; z-index: 110;"></iframe><iframe id="ifmdivAddressMenu" style="position: absolute; z-index: 1; display: none;"></iframe><div id="divAddressMenu" style="display: none;"></div></body></html>