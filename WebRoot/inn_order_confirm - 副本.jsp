...
<!--
		function ch_room_num_sel(){
			...
			$(document).ready(function(){
				...
				var	room_Price = $('#room_Price').val(); //房价
				...
				$('#allroom_Price').val(all_room_Price);
				// alert($('#allroom_Price').html());
				 alert(all_room_Price);
			});
		}
  ...
  <div class="header">
    ...
    <div class="toptent">
      ...
      <div class="topnavcont">
        <div class="navlis">
          <ul>
            <li><a href="http://www.7daysinn.cn/my_msg.php?type=1">我的7天</a></li>
            <li class="on"><a href="http://www.7daysinn.cn/inn_search.html">分店预订</a></li>
      ...
      <div class="userinfotent">
        <div class="user_info" id="myinfo">注册会员：${session .guest .guestname}&nbsp;&nbsp;&nbsp;</div>
        <div class="sub_menu">
          <ul>
	...
	if(dtStart.value.trim()=='')
	{
      ...
      <div class="left_con">
        ...
        <script type="text/javascript">
				  	if (book_left[1]) {document.write( '<a href="'+book_left[1].img_link+'"><img src="'+book_left[1].img_src+'" width="218" height="118" border="0"></a>');}
				  </script>
        <div class="blank10"></div>
        <div> 
          <script type="text/javascript">
				  	if (book_left[2]) {document.write( '<a href="'+book_left[2].img_link+'"><img src="'+book_left[2].img_src+'" width="218" height="118" border="0"></a>');}
...
setText();
    ...
    <div class="right626">
        ...
        <table class="tb10" cellpadding="0" cellspacing="0">
          <tbody>
            <tr>
              ...
              <select name="room_type" disabled="disabled" id="room_type">
                      <option value="0">房间类型</option>
                       <c:forEach var="RoomTypevo" items='${RoomTypeList}'>
       <option value="${RoomTypevo .roomTypeid}${innroomTypeid}" ${RoomTypevo.roomTypeid == innroomTypeid ? 'selected="selected"':""}>
                            ${RoomTypevo .roomTypename}</option>
                       </c:forEach>
                      <!-- ${RoomTypevo.roomTypeid == innroomTypeid ? 'selected="selected"':""}-->
                    </select>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>&nbsp;姓名：
                <input class="blueinput" name="guestname" value="${sessionScope .guest .guestname}" id="guestname" type="text"></td>
                 <input name="guestid" value="${sessionScope .guestid}" type="hidden">
              <td class="bggray ar">身份证号</td>
            ...
            <tr>
              ...
              <td colspan="3"> 首晚基础房价: &nbsp;<input disabled="disabled"  class="room_Price"  id="room_Price" value="${room_Price}" size="5" maxlength="5"/>&nbsp;元 押金：<input disabled="disabled"  name="deposit"  id="deposit" value="200" size="5" maxlength="5"/>　总金额：
              <input disabled="disabled" class="allroom_Price"  id="allroom_Price"  value="${room_Price+200}" size="5" maxlength="5"/>元<br>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <form id="form" name="form" method="post" action="pay.php?mkey=505051886">
        <div class="blank15"></div>
        <div class="contbox">
          <div class="intitle">
            <div class="left"><img src="images/bar2_left.gif" alt=""></div>
