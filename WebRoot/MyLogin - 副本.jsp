...
<meta content="7天连锁酒店集团酒店预订已建立覆盖全国超2000家分店的经济型快捷连锁酒店网络，完善的酒店预订系统，让您预订酒店客房更加轻松快捷，是您出差、旅游好选择。" name="Description">
...
<div class="content">
  ...
  <div class="header">
    ...
    <div class="toptent">
      <div class="listcode">
        <ul>
          <li style="margin-right: 8px;margin-top:18px;"> <span id="index-tips" style=" display:inline;"><a href="http://www.7daysinn.cn/login.php">登录</a><span class="spanString"></span><a href="http://www.7daysinn.cn/reg.php">注册</a><span class="spanString"></span>|<span class="spanString"></span></span><a href="http://m.7daysinn.cn/m" target="_blank">手机版</a><span class="spanString"></span><a href="http://verified.weibo.com/group/7daysinn?o=1" target="_blank">7天官博</a><span class="spanString"></span>|<span class="spanString"></span><a href="http://www.7daysinn.cn/">7天首页</a> </li>
        </ul>
      </div>
  ...
  <!--top end--><script language="javascript" type="text/javascript" src="images/loginTab.js"></script> 
  ...
  <link href="images/loginTab.css" rel="stylesheet" type="text/css">
  <style type="text/css">
<!--
.loginad{position:relative;width:260px;height:220px; background-image:url(login_ad_20130902.gif);}
.loginad .ad{position:absolute;z-index:1;left:65px;top:8px;font-size:20px;font-weight:bold;font-family: Arial;color: #a94215;width: 73px;}
.errmsg {background-color: #FFE1E1;border: 1px solid #FF8080;height:20px;line-height:20px;margin:0px 15px;padding: 0;text-align: center;}

-->
</style>
  <script>
	var returnURL = 'http%3A%2F%2Fwww.7daysinn.cn%2Fmy_msg.php%3Ftype%3D1';
	var cooURL = '';
</script>
  ...
  <div class="main">
    ...
    <div class="box ac">
      <div class="loginad01" style="background:url(images/loginad01.gif) no-repeat;">
        <div class="num"> 超2000 </div>
        <div class="pic"> <img src="images/wxew.gif" width="103" height="104"> </div>
        <div class="text"> 因近期短信服务商调整，短信会出现无法接收或延时，为避免影响您的使用，请关注“7天会”微信。<br>
          PS：“7天会”微信已实现同步发送订单信息，会员权益到账情况。 <a href="http://www.7daysinn.cn/activity.php?action=weixin" target="_blank">查看详情&gt;&gt;</a> </div>
      </div>
    </div>
    ...
    <div class="loginwrap">
      <div class="loginbox">
        <ul class="loginbox_tab" id="tabs">
          <li id="loginTab1" class="lg_member_current">会员登录</li>
          <!--<li id="loginTab2">合作卡登录</li>-->
        </ul>
        
        <!--个人会员登录-->
        <form action="guest.action" method="post">
        <div id="memberlogin">
          <div style="height:20px; padding:2px 0px 0px 96px; color:#F90;">
            <div id="membererror">您需要登录后才能继续刚才的操作</div>
          </div>
          <div style=" padding-top:10px; height:40px;"> <span class="inplabel">会员号：</span>
            <input name="username" class="login_input" id="username" tabindex="1" style="color:#999;" type="text" value="7天会员卡号/手机号码/证件号" onfocus="javascript:if (this.value==&#39;7天会员卡号/手机号码/证件号&#39;) {this.value=&#39;&#39;; this.style.color=&#39;#333&#39;}" onblur="javascript:if (this.value==&#39;&#39;) {this.value=&#39;7天会员卡号/手机号码/证件号&#39;; this.style.color=&#39;#999&#39;}">
          </div>
          <div style=" height:40px;"> <span class="inplabel">密码：</span>
            <input name="password" tabindex="2" class="login_input" id="password" type="password">
            &nbsp;&nbsp;<span class="inplabel2"><a href="http://www.7daysinn.cn/forgetpwd.php" target="_blank"><font color="#0053aa">重置密码</font></a></span> </div>
          <div style="height:35px;"> <span class="inplabel">验证码：</span>
            <input name="safecode" id="safecode" tabindex="3" class="login_input" style="width:100px; color:#999;" type="text" maxlength="4" onfocus="if(this.value==&#39;请点击输入&#39;){this.value=&#39;&#39;;ajaxGenerateSafeCode(1);}" value="请点击输入" onblur="if(this.value==&#39;&#39;){this.value=&#39;请点击输入&#39;;clearSafeCode(1);}">
            &nbsp;<span id="safecode_1" style="display:inline;"></span> </div>
          <div style=" height:25px; padding:0px; margin:7px 0px;">
            <div style="display:none;font-size:12px;" class="errmsg" id="errorInfo"></div>
          </div>
          <div style=" padding:0px 0px 0px 96px; ">
            <input name="btnLogin" class="s_btn" id="btnLogin" type="button" value="登 录" tabindex="4">
            &nbsp;&nbsp;&nbsp;<span class="inplabel2"><a href="http://www.7daysinn.cn/check_card.php" target="_blank" tabindex="5"><font color="#0053aa">纪念卡验证</font></a></span> </div>
        </div>
        </form>
        <!--个人会员登录结束--> 
        ...
        <div id="commonlogin" style="display:none;">
          <div style=" padding-top:22px; height:30px;"> <span class="inplabel">合作卡类：</span>
            <input name="cardType" tabindex="1" class="login_input" id="cardType" type="input" value="请点击选择" readonly="readonly" style="color: rgb(153, 153, 153);">
            <input type="hidden" name="CooID" id="CooID" value="">
          </div>
          <div style="padding-top:10px; height:26px;"> <span class="inplabel">合作卡号：</span>
            <input name="username" tabindex="2" class="login_input" id="username2" type="text" value="合作卡号" style=" color:#999;" onfocus="javascript:if (this.value==&#39;合作卡号&#39;) {this.value=&#39;&#39;; this.style.color=&#39;#333&#39;}" onblur="javascript:if (this.value==&#39;&#39;) {this.value=&#39;合作卡号&#39;; this.style.color=&#39;#999&#39;}">
          </div>
          <div style="padding-top:10px; height:26px;"> <span class="inplabel">密码：</span>
            <input name="password" tabindex="3" class="login_input" id="password2" type="password">
          </div>
          <div style="padding-top:10px; height:26px;"> <span class="inplabel">验证码：</span>
            <input name="safecode" tabindex="4" id="safecode2" class="login_input" style="width:100px; color:#999;" type="text" maxlength="6" onfocus="if(this.value==&#39;请点击输入&#39;){this.value=&#39;&#39;;ajaxGenerateSafeCode(2);}" value="请点击输入" onblur="if(this.value==&#39;&#39;){this.value=&#39;请点击输入&#39;;clearSafeCode(2);}">
            &nbsp;<span id="safecode_2" style="display:inline;"></span> </div>
          <div style=" height:25px; padding:0px; margin:7px 0px;">
            <div style="display:none;font-size:12px;" class="errmsg" id="errorInfos"></div>
          </div>
          <div style=" padding:0px 0px 0px 96px; ">
            <input name="btnCLogin" class="s_btn" style="width:100px;" id="btnCLogin" type="button" value="登 录" tabindex="4">
            &nbsp;
            <input name="allcoop" class="s_btn" style="width:160px;" id="allcoop" type="button" value="全部合作卡活动" tabindex="5" onclick="window.open(&#39;cooper_login.php&#39;);">
          </div>
        </div>
        ...
        <div id="cooperDiv">
          <div class="menu">
            <div class="btnclose"><img src="images/smallClose.gif" width="14" height="14" onclick="closeDiv();"></div>
            <div class="tabbox">
              <div id="cards1" class="tabactive" onclick="cardTabChange(1);">航空卡</div>
              <div id="cards2" class="tabnormal" onclick="cardTabChange(2);">银行卡</div>
              <div id="cards3" class="tabnormal" onclick="cardTabChange(3);">其他卡</div>
            </div>
          </div>
          <div id="cardContent">
            <div id="subCard1" class="subCard" style="display:block;">
              <ul>
                <li><a href="javascript:;" onclick="setCoolID(58,&#39;南方航空&#39;,0)">南方航空</a></li>
                <li><a href="javascript:;" onclick="setCoolID(67,&#39;中国国际航空&#39;,0)">中国国际航空</a></li>
                <li><a href="javascript:;" onclick="setCoolID(66,&#39;东方航空&#39;,0)">东方航空</a></li>
                <li><a href="javascript:;" onclick="setCoolID(32,&#39;海南航空&#39;,0)">海南航空</a></li>
                <li><a href="javascript:;" onclick="setCoolID(33,&#39;厦门航空&#39;,0)">厦门航空</a></li>
                <li><a href="javascript:;" onclick="setCoolID(126,&#39;四川航空&#39;,0)">四川航空</a></li>
              </ul>
            </div>
            <div id="subCard2" class="subCard">
              <ul>
                <li><a href="javascript:;" onclick="setCoolID(30,&#39;广发银行&#39;,0)">广发银行</a></li>
                <li><a href="javascript:;" onclick="setCoolID(76,&#39;兴业银行&#39;,0)">兴业银行</a></li>
                <li><a href="javascript:;" onclick="setCoolID(28,&#39;招商银行&#39;,0)">招商银行</a></li>
                <li><a href="javascript:;" onclick="setCoolID(102,&#39;广发7天联名卡&#39;,0)">广发7天联名卡</a></li>
                <li><a href="javascript:;" onclick="setCoolID(107,&#39;招行7天联名卡&#39;,0)">招行7天联名卡</a></li>
              </ul>
            </div>
            <div id="subCard3" class="subCard">
              <ul>
                <li><a href="javascript:;" onclick="setCoolID(145,&#39;QQ会员&#39;,1)">QQ会员</a></li>
                <li><a href="javascript:;" onclick="setCoolID(136,&#39;唯品会&#39;,0)">唯品会</a></li>
                <li><a href="javascript:;" onclick="setCoolID(130,&#39;QQ彩贝&#39;,1)">QQ彩贝</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div style="width:860px; MARGIN-RIGHT: auto;MARGIN-LEFT: auto;">
      <div class="clear"></div>
    ...
    <div id="CompanyCardLoginTip" style="display:none;">
      <div class="cardLoginTip">您已登录成功。<br>
        7天连锁酒店新推出公司客户差旅管理系统，公司会员可查询预订、入住以及积分累计情况，并可进行下挂个人会员的管理。 <br>
        <span class="inplabe2" style="padding-left:70px;">
        <input class="s_btn" id="gotowww" type="button" value="进入7天官网" onclick="gotowww();" tabindex="1">
        </span> <span class="inplabe2">
        <input class="s_btn" id="gotoco" type="button" value="进入差旅系统" onclick="gotocoo();" tabindex="2">
        </span> </div>
    </div>
    <input type="hidden" name="pages" id="pages" value="1">
    <input type="hidden" name="siteFrom" id="siteFrom" value="">
  ...
  <div class="footer">
    ...
    <div class="footer_sec_2"><a target="_blank" href="http://guangzhou.cyberpolice.cn/netalarm/netalarm/Welcome.jsp?bano=4401050100071"><img height="53" border="0" width="40" galleryimg="no" title="点此查看备案情况" src="images/waicon.gif"></a> </div>
  </div>
