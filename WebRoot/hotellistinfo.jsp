...
function subquery(){
	//alert("预订");
	//document.getElementById("subquery").href=endingURL(document.getElementById("subquery").href);
	//var url=hotellist.action?method=queryRoomTypeVolList&hotelid=${hotel.hotelId}&hotelname=${hotel.hotelName}
	//"hotellist.action?method=queryRoomTypeVolList&hotelid=${hotel.hotelId}&hotelname="+endingURL('${hotel.hotelName})
	//alert(endingURL(document.getElementById("subquery").href));
	//location.href = endingURL(document.getElementById("subquery").href);
}
...
var resetPage = false;
gQueryString[0] = new paramItem("city", "长沙");
gQueryString[1] = new paramItem("zone", "0");
gQueryString[2] = new paramItem("dtStart", "2014-3-31");
gQueryString[3] = new paramItem("dtEnd", "2014-4-1");
gQueryString[4] = new paramItem("hotel_name", "请输入关键词");
	-->
    					</script>
<script type="text/javascript">
...
$(document).ready(function() { 
	...
	var s = "<a href='inn_search.html' >快速预订</a>&nbsp;<span class=nalsecimg> </span>&nbsp;<a href='innmap.html' >从地图进入</a>&nbsp;<span class=nalsecimg> </span>&nbsp;<a href='inn_city_list.html' >按城市列表显示</a>";
	if(s){
		$("#tool").html(s);
	}
});
  ...
  <div class="header">
    ...
    <div class="toptent">
      <div class="listcode">
        <ul>
          <li style="margin-right: 8px;margin-top:18px;"><span
							id="index-tips" style=" display:inline;"><span
								class="spanString"></span><a
								href="mylogin.jsp">退出</a><span
      ...
      <div class="topnavcont">
        <div class="navlis">
          <ul>
            ...
            <li class="on"><a href="hotellist.action?method=queryallRoomTypeVolList&jumpPage=1hotellist.action?method=queryallRoomTypeVolList&jumpPage=1">分店预订</a> </li>
      ...
      <div class="userinfotent">
        <div class="user_info" id="myinfo">会员：${guestinfo .guestName}</div>
        <div class="sub_menu">
          <ul>
            <div id="tool" class="tool"> <a href="hotellist.action?method=queryallRoomTypeVolList&jumpPage=1">快速预订</a>&nbsp;<span
									class="nalsecimg"> </span>&nbsp;<a
									href="http://www.7daysinn.cn/innmap.html">从地图进入</a>&nbsp;<span
									class="nalsecimg"> </span>&nbsp;<a
									href="http://www.7daysinn.cn/inn_city_list.html">按城市列表显示</a> </div>
          </ul>
        </div>
      </div>
    </div>
...
var hasLogin = 0;
  ...
  <script type="text/javascript" src="images/innpage.js"></script> 
  <script type="text/javascript" src="images/tipswindown.js"></script> 
  <script type="text/javascript" src="images/marketTrack.js"></script> 
  <script type="text/javascript" src="images/zone_sel.js"></script>
  <link rel="stylesheet" href="images/tipswindown.css" type="text/css"
			media="all">
  <script language="javascript" type="text/javascript">var thisday = '2014-03-31';
var cityID = '7';
var days = '1';
var city = '长沙';
var innJsAry = [825,18,209,115,128,792,138,853,72,22,984,454,240,723,1351,1304,791,961,237,964,842,23,1497,966,1596,390,595,1336,1014,931,375,1360,965,963,1084,376,535,505,821,33,793,96,967,2085,567,338,707,968,1963,1180,460,20,913,176,783,657,727];
...
function confirmBookingBtn()
{
	var paramStr=$('#InnIdRoomTypeIdClk').val();
	var paramArr = paramStr.split('|');
	for (var i in paramArr){
			//	alert(paramArr[i]+",");
	}
	gotourl(paramArr[0],paramArr[1]);
}
	
function confirmBookingBtns()
{
	var paramStr=$('#InnIdRoomTypeIdClk').val();
	var paramArr = paramStr.split('|');
	var dtOpenDataInsert = $("#dtOpenDataInsert").html();
	var res = bjDate(thisday,dtOpenDataInsert); 
	if(res == true){
		gotourl(paramArr[0],paramArr[1]);
	}else{
		closeWindown();
...
function zonesel($item){
	document.getElementById("zone").options[$item].selected = true;
	document.getElementById("zone2").options[$item].selected = true;
	document.inn_form.submit(); 
}
...
function jifentips($set_hotel_id,$set_room_id,$set_jifen){
	$("#set_hotel_id").attr("value",$set_hotel_id);
	$("#set_room_id").attr("value",$set_room_id);
	$("#set_jifen").attr("value",$set_jifen);
	if(isCooperateCard > 0){
		showTipsWindown("温馨提示", 'cooperateCardTips', 700 , 150);
	}else{
		showTipsWindown("温馨提示", 'jifentips', 700 , 150);
	}
}

function jifen_gotourl(){
	gotourl($("#set_hotel_id").val(),$("#set_room_id").val(),$("#set_jifen").val());
}

function docent(){
	if(rMebType != pMebType){
	if(days == 1 ){
		$.ajax({
			type:"POST",
			url: "ajax/ajax_getQuotaInfo.php?cityID="+cityID+"&dtStart="+thisday+"&city="+escape(city),
			dataType:"json",
			success: function(json){
				if(json.flag == '0'){
					...
					$.each(innJsAry, function(index,value) {
						var _existq5 = $.inArray(value,json.q5);
						if(_existq5 < 0){
							$("#h_"+value+"220").html('<input name="button" type="button" class="inp9" value="5000 积分兑换" title="积分兑换房量有限，先到先得，订完即止。">');
						}
						var _existq7 =  $.inArray(value,json.q7);
						if(_existq7 < 0){
							$("#h_"+value+"221").html('<input name="button" type="button" class="inp9" value="7000 积分兑换" title="积分兑换房量有限，先到先得，订完即止。">');
						}
					});
					if(json.cent5000 !=null){
						var cent5000 = json.cent5000;
						var length5000 = cent5000.length;
						for(a=0;a<length5000;a++){	
							showHtmls(cent5000[a]);
						}
					}
					if(json.cent7000 !=null){
						var cent7000 = json.cent7000;
						var length7000 = cent7000.length;
						for(b=0;b<length7000;b++){
							showHtmls(cent7000[b]);
						}
					}
				}								
			}		
...
function showHtmls(data){
	$("#h_"+data.nInnID+data.nRoomTypeID).html(data.button);
}	
...
-->
  ...
  <div class="main">
    ...
    <div class="left218"> 
      ...
      <script language="javascript" type="text/javascript"
					src="images/city_data.js"></script> 
      <script language="javascript" type="text/javascript"
					src="images/city_date2.js"></script>
      <style type="text/css">
#divAddressMenu {
	position: absolute;
	dispaly: none;
...
function pgInit()
{
	...
	if(dtStart.value.trim()=='')
	{
      ...
      <div class="left_con">
        <div class="lf_a1"></div>
        <form name="inn_form" id="inn_form" method="post" action="hotellist.action?method=searchHotel"
         onsubmit="return checkSearchForm('inn','inn_form')">
          <div class="lf_a2">
            <div class="left_hotel_con">
              <table class="left_tab01">
                <tbody>
                 <tr>
                          <th align="right">入住城市</th>
                          <td width="102"><input name="city" id="city" autocomplete="off" style="width:100px;" value="" class="blueinput" onclick="this.value='';GetCityList(this); DelZone('zone')" onkeyup="OnInputKeyUP(event)" onkeydown="if(event.keyCode==13){WriteCity(gotoIndex+1);_Hidden(document.all?'':'e');HiddenDateBox(); return false;}" type="text">
                		  <input name="hcity" value="" type="hidden">
                									  </td>
                          <td>&nbsp;</td> 
                        </tr>
                        <tr>
                          <th align="right">行政区域</th>
						  <td onmouseover="BuildZone('city','hotcity','zone')" height="25">
							<select name="zone" id="zone" style="width:106px; overflow:hidden"><option selected="selected" value="0">全部区域</option><option value="丰台区">丰台区</option><option value="海淀区">海淀区</option><option value="东城区">东城区</option><option value="昌平区">昌平区</option><option value="朝阳区">朝阳区</option><option value="西城区">西城区</option><option value="房山区">房山区</option><option value="崇文区">崇文区</option><option value="石景山区">石景山区</option><option value="大兴区">大兴区</option><option value="延庆县">延庆县</option><option value="通州区">通州区</option><option value="密云县">密云县</option><option value="宣武区">宣武区</option><option value="怀柔区">怀柔区</option><option value="顺义区">顺义区</option><option value="平谷区">平谷区</option></select>
						  </td>
                          <td>&nbsp;</td>
                        </tr>
                </tbody>
  ...
  $(document).ready(function(){
	  chk_city = 1;
	  BuildZone('city','hotcity','zone','0');
	  pgInit();
  });

</script>
            <div class="inp_lf01">
              <input type="submit" name="inn_submit" value="">
            </div>
          </div>
          <div class="lf_a3"></div>
        </form>
        ...
        <div class="lf_b2">
          <div class="left_map_con">
            ...
            <p style="height:30px;overflow:hidden;">
              <input name="mapcity" id="mapcity" type="text" class="inp"
									style="color:#666666;" value="其他城市"
									onclick="this.value=x" maxlength="9">
              <input
									name="" type="button" class="btn" onclick="return citymap();">
            </p>
          </div>
        </div>
        <div class="lf_b3"></div>
        <div class="blank10"></div>
        <div class="blank10"></div>
        <a href="http://www.7daysinn.cn/activity.php?action=weixin"><img
						src="images/4b6de15ebd56a2d1478bd189624d1b3c.jpg" width="218"
						height="118" border="0"> </a>
        <div class="blank10"></div>
        <a href="http://www.7daysinn.cn/activity_lucky.php"><img
						src="images/2f1ed268f493f2d2d1b5485cab19d7f3.jpg" width="218"
						height="118" border="0"> </a>
        <div class="blank10"></div>
        <a href="http://www.7daysinn.cn/wish2014.php"><img
						src="images/df40cf2fedb570c146f233aa7e1621ab.jpg" width="218"
      ...
      <div> 
        ...
        <script language="javascript" type="text/javascript">									ShowAdPic('www_inn_left_1',1,212,80);
									-->
						   </script> 
        <script language="javascript" type="text/javascript">									ShowAdPic('www_inn_left_2',1,212,80);
									-->
						   </script> 
        <script language="javascript" type="text/javascript">									ShowAdPic('www_inn_left_3',1,212,80);
									-->
						   </script>
        <div class="blank10"></div>
      </div>
...
setText();
    ...
    <div class="right626">
      <div class="titlebox titlebox2">
        <div class="left"> <img src="images/bar_gray2_left.gif" alt=""> </div>
        <div class="middle">
          <h3 class="icon_round1">快速预订</h3>
          <div
							style="float:left;overflow:hidden;margin-top:12px;width: 134px;white-space: nowrap">
            <div align="center">  <span class="fB f14px cOrange">共分店${page.maxCount }</span> 家分店 </div>
          </div>
          <div class="progress"> <a href="javascript:;">查询</a><a class="on">选择</a><a
								href="javascript:;">预订</a><a href="javascript:;">核对</a><a
          ...
          <div>
            <table class="search" cellpadding="0" cellspacing="0"
              ...
              <tbody>
                <tr>
                  <td valign="middle" style="vertical-align:text-bottom;"><div
												style="overflow:hidden; "> 选择区域：
                      <select name="zone2" id="zone2" style="width:75px; overflow:hidden;" onchange="zonesel(this.selectedIndex)"
													onmouseover="BuildZone()">
                        ...
                        <option value="星沙开发区">星沙开发区</option>
                        <option value="宁乡区">宁乡区</option>
                        <option value="浏阳县">浏阳县</option>
                      </select>
                      <span style="width:0px; display:inline-block;"></span> 价格排序：
                      <select name="moremenu2"
													style="width:75px; overflow:hidden;"
													onchange="window.open(this.options[this.selectedIndex].value,target=X)">
                        <option
														value="http://www.7daysinn.cn/inn_list.php?city=%E9%95%BF%E6%B2%99&amp;zone=0&amp;dtStart=2014-3-31&amp;dtEnd=2014-4-1&amp;hotel_name=%E8%AF%B7%E8%BE%93%E5%85%A5%E5%85%B3%E9%94%AE%E8%AF%8D&amp;innsort=0"
														selected="selected">默认排序</option>
                        <option
														value="http://www.7daysinn.cn/inn_list.php?city=%E9%95%BF%E6%B2%99&amp;zone=0&amp;dtStart=2014-3-31&amp;dtEnd=2014-4-1&amp;hotel_name=%E8%AF%B7%E8%BE%93%E5%85%A5%E5%85%B3%E9%94%AE%E8%AF%8D&amp;innsort=1">从低到高</option>
                        <!--                                    <option value="http://www.7daysinn.cn/inn_list.php?city=%E9%95%BF%E6%B2%99&zone=0&dtStart=2014-3-31&dtEnd=2014-4-1&hotel_name=%E8%AF%B7%E8%BE%93%E5%85%A5%E5%85%B3%E9%94%AE%E8%AF%8D&innsort=2" >从高到低</option>    -->
                      </select>
                      <span style="width:0px; display:inline-block;"></span> 评分排序：
                      <select name="moremenu3"
													style="width:75px; overflow:hidden;"
													onchange="window.open(this.options[this.selectedIndex].value,target=X)">
                        <option
														value="http://www.7daysinn.cn/inn_list.php?city=%E9%95%BF%E6%B2%99&amp;zone=0&amp;dtStart=2014-3-31&amp;dtEnd=2014-4-1&amp;hotel_name=%E8%AF%B7%E8%BE%93%E5%85%A5%E5%85%B3%E9%94%AE%E8%AF%8D&amp;innsort=0"
														selected="selected">默认排序</option>
                        <option
														value="http://www.7daysinn.cn/inn_list.php?city=%E9%95%BF%E6%B2%99&amp;zone=0&amp;dtStart=2014-3-31&amp;dtEnd=2014-4-1&amp;hotel_name=%E8%AF%B7%E8%BE%93%E5%85%A5%E5%85%B3%E9%94%AE%E8%AF%8D&amp;innsort=3">从高到低</option>
                        <!--                                    <option value="http://www.7daysinn.cn/inn_list.php?city=%E9%95%BF%E6%B2%99&zone=0&dtStart=2014-3-31&dtEnd=2014-4-1&hotel_name=%E8%AF%B7%E8%BE%93%E5%85%A5%E5%85%B3%E9%94%AE%E8%AF%8D&innsort=4" >从低到高</option>    -->
                      </select>
                    </div></td>
                </tr>
              </tbody>
  ...
  $(document).ready(function(){
	  chk_city = 1;
	  BuildZone('city','hotcity','zone2','0');
  });

</script> 
        </div>
        <div class="right"> <img src="images/bar_gray2_right.gif" alt=""> </div>
        <div class="clear"></div>
      </div>
      <!--一个分店开始-->
      <c:forEach var="hotel" items="${Hotelinfo}">
        ...
        <div class="contbox">
          <div class="intitle">
            ...
            <div class="middle">
              <h4 style="padding-left: 0px"> <a href="http://www.7daysinn.cn/qadd.php" title="Q+服务认证"
                                            target="_blank" style="padding:0px 2px; float:left;"><img
                                            src="images/a233543fa9f1c6b9a56b361b6f7cac3e.gif" alt="Q+服务认证"
                                            width="30" height="30"> </a> <a href="hotellist.action?method=HotelPage&hotelid=${hotel.hotelId}"
                                            title="${hotel.hotelName}">店名:${hotel.hotelName}</a><a name="965">&nbsp;</a> </h4>
              <span class="write"> <a class="icon_little1"
                                        href="http://www.7daysinn.cn/innpage.php?id=983#rsInfo1"
                                        target="_blank">周边商户信息</a> <a class="icon_little2"
                                        href="http://www.7daysinn.cn/map.php?x=112.99284957603&y=28.191056864282&innId=965&city=%E9%95%BF%E6%B2%99&sType=0&end=983"
                                        target="_blank">电子地图</a> <a class="icon_little3"
                                        href="http://www.7daysinn.cn/inn_comments_details.php?ChainNum=965"
                                        target="_blank">好评率<span class="cOrange">97.7 %</span> </a> <!--<a class="icon_little4" href="#">小贴士</a>--> </span> </div>
            <div class="right"> <img src="images/bar2_right.gif" alt=""> </div>
          </div>
          <div class="icon_roundq2"> <span
                                    style="display:block; height:30px;overflow:hidden;padding-left:35px;"> <a href="http://www.7daysinn.cn/qadd.php?act=wifi"
                                    title="免费Wifi覆盖" target="_blank"
                                    style="padding:0px 2px; float:left;"><img
                                        src="images/017405711691d43e75ae89cdccd51a95.gif" alt="免费Wifi覆盖"
                                        width="30" height="30"> </a> <a href="http://www.7daysinn.cn/qadd.php?act=yalan"
                                    title="星级优眠床垫" target="_blank"
                                    style="padding:0px 2px; float:left;"><img
                                        src="images/b8d6d822825c02801bcd3e070a8b4a0f.gif" alt="星级优眠床垫"
                                        width="30" height="30"> </a> <a href="http://www.7daysinn.cn/qadd.php?act=maojin"
                                    title="洁净封包毛巾" target="_blank"
                                    style="padding:0px 2px; float:left;"><img
                                        src="images/4bedbbc535270939faa64f7a43035889.gif" alt="洁净封包毛巾"
                                        width="30" height="30"> </a> <a href="http://www.7daysinn.cn/qadd.php?act=shower"
                                    title="10秒速热淋浴" target="_blank"
                                    style="padding:0px 2px; float:left;"><img
                                        src="images/21e4a1eb7297ba84d299d8b0ca076672.gif" alt="10秒速热淋浴"
                                        width="30" height="30"> </a> </span> </div>
          <div class="info2"> 分店简介${hotel.hotelAbout} </div>
          ...
          <table class="room" cellpadding="0" cellspacing="0">
            <tbody>
              <tr class="th">
                ...
                <td class="td3">门市价</td>
                <td class="td3">会员价</td>
                <td class="td3">会员促销</td>
                <td class="td4">积分兑换</td>
              </tr>
              <c:forEach var="hoteltype" items="${hotel.roomtypeList}">
                <tr>
                  <td class="td1"><span id="a965_223" title="房间具有比较小等不足，更经济实惠。"> ${hoteltype.roomTypename}</span></td>
                  <td class="td22" style="text-align:center;"><!--                                        <input name="Submit23" type="submit"
                                            onclick="gotourl_rewrite(${hoteltype.roomTypeid},${hotel.hotelId})" class="inp1" value="预 订">--> 
                    
                    <a class="inp1" id="subquery" href="hotellist.action?method=queryRoomTypeVolList&hotelid=${hotel.hotelId}&roomTypeid=${hoteltype.roomTypeid}" onclick="subquery()">预 订</a></td>
                  <td class="td3">--</td>
                  <td class="td3" id="p_965223">${hoteltype.roomPrice}</td>
                  <td class="td33"><span style="color:#333333;">--</span></td>
                  <td class="td4" id="h_965223">&nbsp;</td>
                </tr>
              </c:forEach>
            </tbody>
          </table>
          ...
          <!-- <div class="info3">                
                            <span>总分：</span><span class="cOrange">0.00</span> <span>分</span> &nbsp;&nbsp; <span>过去一个月点评数</span> <span class="cOrange"></span> &nbsp;&nbsp; <span>好评</span> <span class="cOrange"></span> &nbsp;&nbsp; <span>中评</span> <span class="cOrange"></span> &nbsp;&nbsp; <span>差评</span> <span class="cOrange"></span>	
                        </div>	--> 
        </div>
      ...
      <!--分页开始-->
      <div class="blank15"></div>
      <div align="center"> 共<span class="tstrong">${page.maxCount }</span> 条记录 &nbsp; 每页显示 <span
						class="tstrong"> ${page.rowsPrePage }行 </span> 条 &nbsp; <span class="comment"><a href="hotellist.action?method=queryallRoomTypeVolList&jumpPage=1">第一页</a></span>&nbsp;&nbsp; <span class="comment"><a href="hotellist.action?method=queryallRoomTypeVolList&jumpPage=${page.curPage-1 }">上一页</a></span>&nbsp;&nbsp; <span class="comment"><a href="hotellist.action?method=queryallRoomTypeVolList&jumpPage=${page.curPage+1 }">下一页</a></span>&nbsp;&nbsp; <span class="comment"><a href="hotellist.action?method=queryallRoomTypeVolList&jumpPage=${page.maxPage }">最后页</a></span>&nbsp; </div>
      <input id="starttime" name="starttime" value="2014-03-31"
					type="hidden">
      <input id="endtime" name="endtime"
					value="2014-04-01" type="hidden">
      <br>
      <br>
    </div>
    <div class="clear"></div>
    <div class="main_bottom"></div>
    <input type="hidden" id="InnIdRoomTypeIdClk"
				name="InnIdRoomTypeIdClk" value="">
  </div>
  <div class="blank10"></div>
  
  <!--提示 start-->
  <input type="hidden" id="set_hotel_id" value="">
  <input
			type="hidden" id="set_room_id" value="">
  <input type="hidden"
			id="set_jifen" value="">
  <div id="jifentips" style="display:none; cursor: default;padding:0px;">
    <table width="97%" border="0" cellpadding="0" cellspacing="3">
      <tbody>
        <tr>
          <td style="width:110px;" align="center" valign="top"><img
							src="images/02.jpg" width="104" height="124"></td>
          <td align="left" style="padding-top:15px;"><div
								style="text-align:left;line-height:20px;text-indent:24px;font-size:14px;">亲爱的会员，积分兑换房限本人预订入住（入住人须与预订会员资料吻合，并在前台读取二代身份证办理入住），预订后不能修改，已兑换的积分不能返还，请确认您的行程安排。</div>
            <div align="center" style="margin-top:30px; margin-bottom:0px;">
              <input type="button" class="btn_bg_icon_07" value="知道了，继续"
									name="Submit2" id="confirmBookingBtn"
									onclick="jifen_gotourl();">
              &nbsp;&nbsp;&nbsp;
              <input
									type="button" class="btn_bg_icon_06" value="返回" name="Submit2"
									onclick="closeWindown()">
            </div></td>
      ...
      <tbody>
        <tr>
          <td style="width:110px;" align="center" valign="top"><img
							src="images/02.jpg" width="104" height="124"></td>
          <td align="left" style="padding-top:15px;"><div
								style="text-align:left;line-height:20px;text-indent:24px;font-size:14px;">如需预订异地免费房、积分兑换房、77元，88元新店体验等特价房，请以7天会员身份登录并预订。</div>
            <div align="center" style="margin-top:30px; margin-bottom:0px;">
              <input type="button" class="btn_bg_icon_07" value="重新登录"
									name="Submit2" id="confirmBookingBtn"
									onclick="location.href='inn_list.php?hotcity=长沙'">
              &nbsp;&nbsp;&nbsp;
              <input type="button" class="btn_bg_icon_07" value="取消预订" name="Submit2" onclick="">
            </div></td>
          <td style="width:20px;">&nbsp;</td>
        </tr>
      </tbody>
  ...
  <div class="footer">
    ...
    <div class="footer_sec_2"> <a target="_blank"
					...
					height="53" border="0" width="40" galleryimg="no" title="点此查看备案情况"
					src="images/waicon.gif"> </a> </div>
  </div>
...
<script>//hf();</script>
<iframe id="CalFrame" name="CalFrame" frameborder="0"
		src="images/datecom.htm" width="452" height="190" scrolling="no"
		style="display: none; position: absolute; z-index: 110;"></iframe>
<iframe id="ifmdivAddressMenu"
		style="position: absolute; z-index: 1; display: none;"></iframe>
<div id="divAddressMenu" style="display: none;"></div>
</body>
</html>
