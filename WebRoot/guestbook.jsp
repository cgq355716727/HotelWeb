	...
	if($("#selectPayType1").length>0 || $("#CompanyStored").length > 0){
		...
		location.href='pay_after.php?fid='+fid+'&innid='+oid;
			...
			function addMsg(){
				...
				if(!vform.msgTitle.value){
					alert("请输入主题！")
					vform.msgTitle.focus();
					return;
				}
				 
				if(!vform.msgContent.value){
					alert("请输入留言内容！")
					vform.msgContent.focus();
					return;
				}
				if( vform.msgContent.value.length < 10 ){
					alert("请认真填写留言内容！")
					vform.msgContent.focus();
					return;
				}
        ...
        <div class="my7day-left-con">
          ...
          <div class="my7day-list02">
            <ul>
              ...
              <li><a href="msg.action?method=showMsg&jumpPage=1">我的留言</a></li>
            </ul>
          </div>
        </div>
      ...
      <div class="contbox">
        ...
        <div class="tabcon">
          <table class="tablist08" id="ejiaA1" cellpadding="0" cellspacing="0">
            <tbody>
              <tr>
                <th class="bggray" valign="middle" width="50">编号</th>
                <th class="bggray">主题</th>
                <th class="bggray" width="60">房型</th>
                <th class="bggray" width="40">总价</th>
                <th class="bggray" width="64">入店日期</th>
                <th class="bggray" width="64">离店日期</th>
                <th class="bggray" width="50">状态</th>
              ...
              <tr>
                <td colspan="8" height="40"><div>
                    ...
                    <table class="pagenum01" cellpadding="0" cellspacing="0" align="left" width="628" height="143" style="width: 631px;">
                      <tbody>
                      </tbody>
  <c:forEach var="msg" items="${msginfo }">
		    <tr>
                <th class="bggray" >留言编号: ${msg.msgId }</th>
                <th class="bggray" > 留言者: ${msg.guestId }</th>
                <th class="bggray" >主题: ${msg.msgTitle } </th>
                <th class="bggray">留言时间: ${msg.msgDate } </th>
                <tr>
		  			<td class="bggray" colspan="2">内容: ${msg.msgContent }    </td>
		  		</tr>
        ...
        <div class="mana_tip">
          <table class="msg" id="msgA1" cellpadding="0" cellspacing="0">
		 ...
		 <table align="center" width="100%">
		 	<tr>
		 		<td align="right">
		 			...
		 			<a href="msg.action?method=showMsg&jumpPage=1">首页</a>&nbsp;&nbsp;&nbsp;
		 			<a href="msg.action?method=showMsg&jumpPage=${page.curPage-1 }">上一页</a>
		 		 
		 		 
					<a href="msg.action?method=showMsg&jumpPage=${page.curPage-0+1 }">下一页</a>
		 			&nbsp;&nbsp;&nbsp;<a href="msg.action?method=showMsg&jumpPage=${page.maxPage }">尾页</a>		 		
		 	 	  
					 		
		 		 	&nbsp;&nbsp;总共${page.maxCount }行&nbsp;&nbsp;每页显示 
				${page.rowsPrePage }行&nbsp;&nbsp;总共 ${page.maxPage }页&nbsp;&nbsp;&nbsp;&nbsp;当前为第${page.curPage } 页</td>       
		 	</tr>
		 </table>	
<br/>
<br/>
...
<form action="msg.action" method="post" name="form1">
	<table width="100%"  border="1" cellspacing="0">
	  <tr>
	    <td colspan="2" align="center">最新留言</td>
	  </tr>
	  <tr>
	    <td width="20%" align="center">主题:    </td>
	    <td width="100%"><input type="text" name="msgTitle" size="52"></td>
	  </tr>
	  <tr>
	  
	    <td valign="top" align="center">内容:    </td>
	    <td valign="top"><textarea name="msgContent" rows="10"  cols="70"></textarea>
	    <input type="hidden" name="method" value="addMsg"/>	
	    </td>
	  </tr>  
	  <tr>
	    <td valign="top">操作</td>
	    <td valign="top"><input type="button" value="提交" onclick="addMsg();" /></td>
	  </tr> 
	</table> 	 
</form>
          </table>
