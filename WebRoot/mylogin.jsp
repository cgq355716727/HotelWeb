...
<div class="content">
  ...
  <div class="header">
    ...
    <div class="toptent">
      <div class="listcode">
        <ul>
          <li style="margin-right: 8px;margin-top:18px;"> <span id="index-tips" style=" display:inline;"><a href="mylogin.jsp">登录</a><span class="spanString"></span><a href="reg.jsp">注册</a><span class="spanString"></span>|<span class="spanString"></span></span><a href="http://m.7daysinn.cn/m" target="_blank">手机版</a><span class="spanString"></span><a href="http://verified.weibo.com/group/7daysinn?o=1" target="_blank">7天官博</a><span class="spanString"></span>|<span class="spanString"></span><a href="http://www.7daysinn.cn/">7天首页</a> </li>
        </ul>
      </div>
  ...
  <div class="main">
    ...
    <div class="loginwrap">
      <div class="loginbox">
        ...
        <!--个人会员登录-->
        <form action="guest.action?method=login" method="post" id="form1">
        <div id="memberlogin">
          ...
          <div style=" padding-top:10px; height:40px;"> <span class="inplabel">会员号：</span>
            <input name="guestName" class="login_input" id="username" tabindex="1" style="color:#999;" type="text" value="7天会员卡号" onfocus="javascript:if (this.value=='7天会员卡号') {this.value=''; this.style.color='#333'}" onblur="javascript:if (this.value=='') {this.value='7天会员卡号/'; this.style.color='#999'}"> 
          </div>
          <div style=" height:40px;"> <span class="inplabel">密码：</span>
            <input name="guestPw" tabindex="2" class="login_input" id="password" type="password">
          ...
          <div style=" padding:0px 0px 0px 96px; ">
            <input name="btnLogin" class="s_btn" id="btnLogin" type="submit" value="登 录" tabindex="4">
            &nbsp;&nbsp;&nbsp; </div>
        </div>
        </form>
        <!--个人会员登录结束--> 
